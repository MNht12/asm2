    ...
    public static void main(String[] args) {
        ...
        while (true) {
            ...
            try {
                ...
                if (cartNumber.equals("QUIT") || cartNumber.equals("quit")) { // If user enter quit/Quit then exit the
                                                                              // program
                    break;
                }
                    ...
                    try {
                        ...
                        switch (option) {
                            case 1: {
                                ...
                                System.out.println(
                                        "It is a Physical or Digital product? (Please enter \"physical\" or \"digital\")");
                                String askValue = scanner.next();
                                if (askValue.startsWith("physical")) {
                                    Scanner sc1 = new Scanner(System.in);
                                    System.out.println("Quantity?");
                                    Integer quan = sc1.nextInt();
                                    sc1.nextLine();
                                    ...
                                    Integer weight = sc1.nextInt();
                                    sc1.nextLine();

                                    System.out.println("Gift?. please type \"true\" or \"false\"");
                                    boolean gift = sc1.nextBoolean();
                                    sc1.nextLine();

                                    System.out.println("Tax?");
                                    String tax = sc1.nextLine();
                                    list.addProductP(name, des, quan, price, weight, tax, gift);

                                } else if (askValue.startsWith("digital")) {
                                    Scanner sc1 = new Scanner(System.in);
                                    System.out.println("Quantity?");
                                    Integer quan = sc1.nextInt();
                                    sc1.nextLine();
                                    ...
                                    list.addProductD(name, des, quan, price, tax, gift);
                                }
                                System.out.println(list.productSet);
